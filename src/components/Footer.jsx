...
const Footer = () => {
  ...
  const services = [
    ...
    { name: 'Documentation Processing', nameNp: 'कागजात प्रशोधन', icon: DocumentTextIcon },
    { name: 'Visa Assistance', nameNp: 'भिसा सहायता', icon: ShieldCheckIcon },
    { name: 'Training & Orientation', nameNp: 'प्रशिक्षण र अभिमुखीकरण', icon: AcademicCapIcon },
    { name: 'Travel Arrangements', nameNp: 'यात्रा व्यवस्था', icon: GlobeAltIcon },
    { name: 'Welfare Monitoring', nameNp: 'कल्याण अनुगमन', icon: BuildingOfficeIcon }
  ];
  ...
  return (
    <footer id="footer" className="bg-gradient-to-b from-[#1B1948] to-[#004876]">
      {/* Top Wave Design */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
                Nepal's leading manpower recruitment agency, connecting skilled workers 
                with international opportunities since 2009.
              </p>
              <div className="bg-[#004876]/30 backdrop-blur-sm rounded-lg p-3 border border-blue-400/20">
                <p className="text-blue-200 text-xs font-medium mb-1">Government Licensed</p>
              ...
              {quickLinks.map((link, index) => (
                <li key={index}>
                  ...
                  >
                    ...
                    <span>{link.name}</span>
                    <span className="text-blue-300 text-xs ml-1">• {link.nameNp}</span>
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <p className="text-blue-200 text-sm mb-4">हामीले सेवा गर्ने देशहरू</p>
            <ul className="space-y-3">
            ...
            <div className="mt-6 bg-gradient-to-r from-[#1e3a8a] to-[#004876] rounded-lg p-4 border border-blue-400/30">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-white font-bold">15+ Years</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h5 className="text-white font-medium mb-1 text-sm">Office Address</h5>
                <p className="text-gray-300 text-xs leading-relaxed">
                  Maiti Marga, Pingalasthan-09<br />
            ...
            <div className="flex items-start">
              ...
              <div>
                <h5 className="text-white font-medium mb-1 text-sm">Phone & Fax</h5>
                ...
                <p className="text-gray-300 text-xs mt-1">📠 Fax: {contactInfo.fax}</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h5 className="text-white font-medium mb-1 text-sm">Email Contacts</h5>
                <a 
            ...
            <div className="flex items-start">
              ...
              <div>
                <h5 className="text-white font-medium mb-1 text-sm">Business Hours</h5>
                <p className="text-gray-300 text-xs">
                  Sun - Fri: 9:00 AM - 6:00 PM<br />
                  Saturday: 10:00 AM - 4:00 PM
                </p>
                <p className="text-blue-300 text-xs mt-1">⚡ Emergency: On Call</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-3 md:mb-0">
              <p className="text-gray-400 text-sm">
                © {currentYear} Peace International Pvt. Ltd. All rights reserved.
              </p>
              <p className="text-blue-300 text-xs mt-1">
                Licensed by Department of Foreign Employment, Government of Nepal
              </p>
            </div>
            <div className="flex items-center space-x-4">
              <Link to="/information" className="text-gray-400 hover:text-white text-xs transition-colors duration-200">
                Recruitment Process
              </Link>
              <span className="text-gray-600">•</span>
              <Link to="/services" className="text-gray-400 hover:text-white text-xs transition-colors duration-200">
                Terms & Conditions
              </Link>
              <span className="text-gray-600">•</span>
              <Link to="/about" className="text-gray-400 hover:text-white text-xs transition-colors duration-200">
                Privacy Policy
              </Link>
            </div>
          </div>
      ...
      {/* Developer Credit - Subik Digital */}
      <div className="bg-gradient-to-r from-[#0a0a0a] to-[#1a1a2e] border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0">
            <div className="flex items-center text-center">
              ...
              <a 
                href="https://subikdigital.com" 
                target="_blank" 
                rel="noopener noreferrer"
                className="ml-2 font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600 hover:from-purple-600 hover:to-blue-400 transition-all duration-300 text-sm"
              >
                Subik Digital Hub
              </a>
            </div>
            <span className="hidden sm:inline text-gray-600 mx-3">|</span>
            <p className="text-gray-500 text-xs">
              Professional Web Solutions & Digital Marketing
            </p>
          </div>
        </div>
      </div>
